...
// RAVEN END
	...
	cmdSystem->AddCommand( "playerModel",			Cmd_PlayerModel_f,			CMD_FL_GAME|CMD_FL_CHEAT,	"sets the \
																											n model on the player", idCmdSystem::ArgCompletion_Decl<DECL_MODELDEF> );
